 ...
 * 不必等某天恰好有人手工清理。
 */
function pruneDailyRequests(dailyRequests: Record<string, number>) {
...
export function updateRequestStats(request: Request, runtimeEnv?: RuntimeEnv) {
