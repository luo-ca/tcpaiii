  ...
  return (
    <section id="docs-teaser" className="relative z-10 px-4 py-12 sm:px-6 sm:py-16">
      <div className="mx-auto max-w-6xl">
        <div className="glass-strong overflow-hidden rounded-3xl border border-white/60 shadow-lg">
          <div className="flex flex-col gap-6 p-6 sm:p-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              ...
              <div className="mt-5 flex flex-wrap gap-2.5">
                {HIGHLIGHTS.map((item) => (
                  ...
                  >
                    <item.icon className="h-3.5 w-3.5 shrink-0 text-brand-500" />
            ...
            <NavLink
              to="/docs"
              className="inline-flex shrink-0 items-center justify-center gap-1.5 self-start rounded-xl bg-gradient-to-r from-brand-600 to-brand-500 px-5 py-3 text-sm font-medium text-white shadow-md shadow-brand-600/25 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-brand-600/40 lg:self-auto"
            >
              查看完整 API 文档
