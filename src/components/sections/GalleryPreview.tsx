    ...
    <section id="gallery-preview" className="relative z-10 px-4 py-16 sm:px-6 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-6xl">
        <div className="reveal mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <NavLink
            to="/gallery"
            className="inline-flex shrink-0 items-center gap-1.5 self-start rounded-xl border-2 border-ink bg-white px-4 py-2 text-sm font-medium text-foreground shadow-[2px_2px_0_0_var(--color-ink)] transition-transform motion-safe:hover:-translate-x-0.5 motion-safe:hover:-translate-y-0.5 sm:self-auto"
          >
            浏览完整图库
            {data && data.total > 0 && (
